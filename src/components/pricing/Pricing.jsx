    ...
    <section className="pricing container section" id="pricing">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          <img src="/assets/price-1.svg" alt="" className="pricing__img" />
        ...
        <div className="pricing__item best">
          ...
          <img src="/assets/price-2.svg" alt="" className="pricing__img" />
        ...
        <div className="pricing__item">
          <img src="/assets/price-3.svg" alt="" className="pricing__img" />
